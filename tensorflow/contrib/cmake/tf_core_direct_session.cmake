...
list_sources(tf_core_direct_session_srcs)
list_sources(tf_core_direct_session_test_srcs)

resolve_duplicate_filenames(tf_core_direct_session_srcs "${tf_src_regex}")
add_library(tf_core_direct_session ${TF_LIB_TYPE} ${tf_core_direct_session_srcs})
tf_install_lib(tf_core_direct_session)
target_link_libraries(tf_core_direct_session PUBLIC tf_core_cpu)
target_any_link_libraries(tf_core_direct_session PUBLIC "${tensorflow_EXTERNAL_PACKAGES}")
